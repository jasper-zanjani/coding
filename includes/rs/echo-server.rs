// https://www.brandons.me/blog/bufread-and-when-to-use-it
...
/*
  We open a TCP socket on localhost, and wait for incoming connections. 
  When one is made, we spawn a new thread, generate a 1MB array of junk 
  bytes (0-255 over and over), and send it all over the socket.
*/
