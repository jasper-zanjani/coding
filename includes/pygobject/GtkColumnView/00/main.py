...
class MyApp(Adw.Application):
    def do_activate(self):
        ...
        col1.get_factory().connect("bind", self._on_factory_bind, "name")
        col2.get_factory().connect("setup", self._on_factory_setup)
        col2.get_factory().connect("bind", self._on_factory_bind, "registry")
        col3.get_factory().connect("setup", self._on_factory_setup)
        col3.get_factory().connect("bind", self._on_factory_bind, "franchise")
